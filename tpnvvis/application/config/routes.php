...
$route['transport/create'] = 'transport/create';
$route['transport/update'] = 'transport/update';
$route['transport/(:any)'] = 'transport/view/$1';
...
$route['users/invoices/(:any)'] = 'users/invoices/$1';
...
$route['classes/transport/(:any)'] = 'classes/transport/$1';
